...
public class ItemRendererFilterChest implements IItemRenderer{
	...
	public void renderItem(ItemRenderType itemRenderType, ItemStack itemStack, Object... data) {
		...
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(new ResourceLocation(References.MOD_ID.toLowerCase() + ":textures/models/filterChest" + textureName + ".png"));
