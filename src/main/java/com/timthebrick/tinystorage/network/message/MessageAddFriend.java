...
public class MessageAddFriend implements IMessage, IMessageHandler<MessageAddFriend, IMessage> {

    private float xCoord, yCoord, zCoord;
    private UUID playerUUID;
    private String playerName;

    public MessageAddFriend(){
    }

   public MessageAddFriend(UUID id, String playerName, float xCoord, float yCoord, float zCoord) {
        this.playerUUID = id;
