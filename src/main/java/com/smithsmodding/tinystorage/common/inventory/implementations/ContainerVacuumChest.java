...
public class ContainerVacuumChest extends ContainerTinyStorage {

	// Small Chest
	private static final int SMALL_CHEST_INVENTORY_ROWS = 1;
	private static final int SMALL_CHEST_INVENTORY_COLUMNS = 9;
	...
	private static final int MEDIUM_CHEST_INVENTORY_COLUMNS = 9;
	...
	private static final int LARGE_CHEST_INVENTORY_COLUMNS = 9;
	...
	public ContainerVacuumChest(InventoryPlayer inventoryPlayer, TileEntityVacuumChest tileEntity) {
