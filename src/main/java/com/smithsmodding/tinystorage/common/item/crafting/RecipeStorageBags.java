package com.smithsmodding.tinystorage.common.item.crafting;

import com.smithsmodding.tinystorage.common.item.ItemStorageBag;
...
public class RecipeStorageBags implements IRecipe {
    ...
    public boolean matches (InventoryCrafting inventoryCrafting, World world) {
        ...
        for (int i = 0; i < inventoryCrafting.getSizeInventory(); ++i) {
            ...
            if (currentStack != null) {
                if (currentStack.getItem() instanceof ItemStorageBag) {
                    if (itemStack != null) {
                        return false;
                    }
    ...
    public ItemStack getCraftingResult (InventoryCrafting inventoryCrafting) {
        ItemStack itemStack = null;
        ItemStorageBag itemStorageBag = null;
        ...
        for (k = 0; k < inventoryCrafting.getSizeInventory(); ++k) {
            ...
            if (currentStack != null) {
                if (currentStack.getItem() instanceof ItemStorageBag) {
                    itemStorageBag = (ItemStorageBag) currentStack.getItem();
                    ...
                    if (itemStorageBag.hasColor(currentStack)) {
                        currentColor = itemStorageBag.getColor(itemStack);
        ...
        if (itemStorageBag == null) {
            ...
            itemStorageBag.setColor(itemStack, newColor);
            return itemStack;
        }
    }
