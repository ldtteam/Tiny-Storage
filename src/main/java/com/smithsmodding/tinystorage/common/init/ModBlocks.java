...
import com.smithsmodding.tinystorage.common.block.storage.chests.*;
import com.smithsmodding.tinystorage.common.item.block.*;
import com.smithsmodding.tinystorage.common.reference.References;
import com.smithsmodding.tinystorage.common.block.material.BlockBlueLog;
import com.smithsmodding.tinystorage.common.block.material.BlockDenseMaterial;
...
import com.smithsmodding.tinystorage.common.block.storage.BlockPiggyBank;
...
public class ModBlocks {
     ...
     * @param itemclass The item type to register with it : null registers a block
     *                  without associated item.
     * @param name      The mod-unique name to register it as, will get prefixed by
     *                  your modid.
     */
