...
import com.smithsmodding.tinystorage.common.block.storage.chests.BlockPeacefulChest;
...
public class TileEntityRendererPeacefulChest extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick) {
		if (tileEntity instanceof TileEntityPeacefulChest) {
			...
			if (block instanceof BlockPeacefulChest) {
				BlockPeacefulChest blockChest = (BlockPeacefulChest) block;
				this.bindTexture(new ResourceLocation(References.MOD_ID.toLowerCase() + ":textures/models/chests/peacefulChest.png"));
			}
