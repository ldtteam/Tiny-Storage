...
import com.smithsmodding.tinystorage.common.block.storage.chests.BlockVacuumChest;
		...
		if (tileEntity instanceof TileEntityVacuumChest) {
			...
			if (Minecraft.getMinecraft().thePlayer.getHeldItem() != null) {
				if (Minecraft.getMinecraft().thePlayer.getHeldItem().getItem() != null && Minecraft.getMinecraft().thePlayer.getHeldItem().getItem() instanceof ItemDebugTool) {
					ItemDebugTool.OperationModeSettings operationMode = ItemDebugTool.OperationModeSettings.values()[NBTHelper.getInteger(Minecraft.getMinecraft().thePlayer.getHeldItem(), "operationMode")];
					if (operationMode == ItemDebugTool.OperationModeSettings.RENDER_AREA) {
						GL11.glPushMatrix();
