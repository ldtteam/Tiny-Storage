...
import com.smithsmodding.tinystorage.common.inventory.implementations.ContainerClayChest;
import com.smithsmodding.tinystorage.common.reference.Names;

public class GuiClayChest extends GuiTinyStorage {

    private TileEntityClayChest tileEntity;

    public GuiClayChest(InventoryPlayer inventoryPlayer, TileEntityClayChest tileEntity) {
        super(new ContainerClayChest(inventoryPlayer, tileEntity), tileEntity);
