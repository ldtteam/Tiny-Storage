...
import com.smithsmodding.tinystorage.client.gui.widgets.settings.*;
...
import com.smithsmodding.tinystorage.network.message.MessagePlayerJoinGui;
import com.smithsmodding.tinystorage.network.message.MessagePlayerLeaveGui;
...
public class GuiTinyStorage extends GuiContainer implements IContainerWidgetProvider, INEIGuiHandler {
    ...
    public void onGuiClosed() {
        TinyStorageLog.info(this.getMinecraft().thePlayer == null);
